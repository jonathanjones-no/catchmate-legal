...
For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to name, email, phone number, photos, location, age/birthday. The information that the Service Provider request will be retained by them and used as described in this privacy policy.

## Age Requirement

The Application is intended for users aged 18 and older. By using the Application, you confirm that you are at least 18 years of age. The Application uses age verification mechanisms, including Apple Declared Age Range API (iOS), Google Play Age Signals (Android), and self-declared date of birth verification to enforce this requirement. Users determined to be under 18 will be unable to use the Application.

## Push Notifications

The Application may send you push notifications related to your activity, including but not limited to new matches, chat messages, session proposals, and session reminders. You can disable push notifications at any time through your device settings or within the Application's notification settings.

## Real-Time Messaging

The Application provides real-time messaging functionality between matched users. Message content is stored on our servers and is accessible only to the participants of the conversation. Messages are retained for as long as the match exists or until a user deletes their account.

## Account Deletion

You may delete your account at any time through the Application by navigating to Settings > Account > Delete Account. Upon account deletion, all of your personal data will be permanently removed from our servers, including your profile information, messages, matches, sessions, swipes, availability data, photos, and any other data associated with your account. This action is irreversible.
...
This privacy policy page was generated by [App Privacy Policy Generator](https://app-privacy-policy-generator.nisrulz.com/) and customized for Catchmate.
